...
extern void     pte_set_frame(pt_entry *entry, uint32_t physaddr);
extern bool     pte_is_present (pt_entry entry);
extern bool     pte_is_writeable(pt_entry entry);
extern uint32_t pt_entry_pfn(pt_entry entry); 
